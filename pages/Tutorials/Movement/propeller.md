...
Spin-drilling is done by pressing `DOWN` after spinning and being high enough above the ground below you. This will make Mario move downward with `-4.0` Y-speed, the same Y-speed as ground-pounding. Note that you cannot slightly move left or right while spin-drilling like you can while ground-pounding.  
...
<div class="gif-container">
  <img src="" alt="8-1 shellboost">
</div>
<i><small>Notice Mario's speed accelerate from `2.5` to `3.0` after throwing the buzzy beetle. This is "8-1 shellboost" and was the first strat that used throwing to cancel a spin.</small></i>
...
<i><small>This wallkick's timing is hard to get down at first but is essential to getting "556" in 5-Tower.</small></i>

<i class="fas fa-info-circle" style="font-size: 0.8em; color: #007bff;"></i> <i>The `Spin Timer` shown in the Info Display counts down the frames until you can wallkick with prop.</i>
...
<div class="gif-container">
  <img src="" alt="5-t semisolid instantland">
</div>
<i><small></small></i>
